...
<div style="background-color: #222; width: 100%; text-align: center; font-size: 10px; color: #fff; min-height: 20px; line-height: 10px; padding: 5px 0;">
  Website designed by: <a style="color: white; text-decoration: underline;" target="_blank" title="Contact Developer here: https://damianorourke.info" href="https://damianorourke.info">
&#64;damianorourke.info</a>
</div>
...
jQuery(document).ready(function($) {
  ...
  $('.image-wrap').on("click", function(){
    console.log("click");
    let $some = $('#owp-qv-content');
    console.log($some);
    if($some){
      console.log("it is there");
      let $elem = document.querySelector('#donation_amount_field');
